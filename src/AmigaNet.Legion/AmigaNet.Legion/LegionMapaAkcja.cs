    ...
    public partial class Legion
    {
        void MAPA_AKCJA()
        {
            ...
            if (amos.Rnd(P) == 1)
            {
                for (var I = 20; I <= 39; I++)
                {
                    if (ARMIA[I, 0, TE] == 0)
                    {
                        ...
                        MESSAGE2(I, TR("MAP_CHAOS_ARRIVE"), 38, 0, 0);
                        NOWA_ARMIA(I, 10, 11);
                        ARMIA[I, 0, TMAG] = 5;
            ...
            for (var A = 0; A <= 19; A++)
            {
                ...
                if (ARMIA[A, 0, TE] > 0)
                {
                    ...
                    if (DNI < 5 && DNI > 0)
                    {
                        MESSAGE(A, TR("MAP_FOOD_RUNNING_OUT"), 0, 0);
                    }
                    if (ZARCIE <= 0)
                    {
                        MESSAGE(A, TR("MAP_ARMY_DISBANDED"), 0, 0);
                        ZABIJ_ARMIE(A);
                        B_CLEAR(A);
                        goto OVER_NEXT;
                    }
            ...
            for (var M = 0; M <= 49; M++)
            {
                ...
                if (CZYJE == 1)
                {
                    ...
                    if (MORALE <= 0)
                    {
                        ...
                        if (JEST)
                        {
                            A_S = A_S + TR("MAP_REVOLT_ARMY_FIGHT", ARMIA_S[_ATAK, 0]);
            ...
            if (Math.Abs(DX) < 3 && Math.Abs(DY) < 3)
            {
                ...
                if (TRYB == 3 && C == 0)
                {
                    ...
                    if (SYMULACJA)
                    {
                        ...
                        {
                            MESSAGE2(LOSER, TR("MAP_ARMY_WAS_DEFEATED_DOT"), 33, 0, 0);
                        }
                    }
                    else
                    {
                        ...
                        {
                            CENTER(X1, Y1, 1);
                            MESSAGE(A, TR("MAP_ATTACKED_OUR", A_S), 0, 0);
                        ...
                        if (ARMIA[B, 0, TE] == 0)
                        {
                            MESSAGE2(B, TR("MAP_WAS_DEFEATED"), 33, 0, 0);
                        }
                        if (ARMIA[A, 0, TE] == 0)
                        {
                            MESSAGE2(A, TR("MAP_WAS_DEFEATED"), 33, 0, 0);
                        }
                    }
                }
                if (TRYB == 3 && C == 1)
                {
                    ...
                    if (SYMULACJA)
                    {
                        ...
                        if (ARMIA[40, 0, TE] == 0)
                        {
                            ...
                            {
                                CENTER(X1, Y1, 1);
                                MESSAGE2(A, TR("MAP_CAPTURED_SETTLEMENT", A_S), 32, 0, 0);
                            }
                        }
                        if (ARMIA[A, 0, TMAGMA] == 100)
                        {
                            ...
                            {
                                CENTER(X1, Y1, 1);
                                MESSAGE2(A, TR("MAP_DEFEATED_DURING_ASSAULT", A_S), 33, 0, 0);
                            }
                        }
                    }
                    else
                    {
                        if (A > 19 && PL2 == 1)
                        {
                            ...
                            {
                                CENTER(X1, Y1, 1);
                                var KON_S = TR(PL == 5 ? "VERB_ATTACK_PL" : "VERB_ATTACK_SG");
                                MESSAGE(A, TR("MAP_ATTACK_OUR_SETTLEMENT", KON_S, A_S), 0, 0);
                                for (var I = 1; I <= 10; I++)
                                {
                                    ARMIA[A, I, TAMO] = 30;
                                }
                                ...
                                if (WYNIK_AKCJI != 1)
                                {
                                    ...
                                    {
                                        MIASTA[B, 0, M_CZYJE] = PL;
                                        MESSAGE2(A, TR("MAP_CAPTURED_OUR_SETTLEMENT", A_S), 30, 0, 0);
                                    }
                                    B_OFF(A);
                                    screens.PasteBob(MIASTA[B, 0, M_X] - 8, MIASTA[B, 0, M_Y] - 8, MB);
                                    screens.WaitVbl();
                            ...
                            else
                            {
                                if (PL == 5)
                                {
                                    ...
                                    MESSAGE2(B, TR("MAP_CITY_BURNED"), 32, 1, 0);
                                    MB = 8;
                                }
                                else
                                {
                                    MIASTA[B, 0, M_CZYJE] = PL;
                                    CENTER(X1, Y1, 1);
                                    MESSAGE(A, TR("MAP_SEIZED_OUR_SETTLEMENT", A_S), 0, 0);
                                }
                                B_OFF(A);
                                screens.PasteBob(MIASTA[B, 0, M_X] - 8, MIASTA[B, 0, M_Y] - 8, MB);
                                screens.WaitVbl();
                        ...
                        {
                            CENTER(X1, Y1, 1);
                            MESSAGE(A, TR("MAP_BEGIN_ATTACK_SETTLEMENT", A_S), 0, 0);
                            var ILEDNI = amos.Rnd(30) + 10;
                            WOJNA[PL, PL2] = ILEDNI;
                            WOJNA[PL2, PL] = ILEDNI;
                            var OLDPOWER = POWER;
                            ...
                            if (ARMIA[40, 0, TE] == 0)
                            {
                                ...
                                MESSAGE2(A, TR("MAP_WE_CAPTURED_SETTLEMENT", A_S), 30, 0, 0);
                            }
                            if (ARMIA[A, 0, TE] == 0)
                            {
                                MESSAGE2(A, TR("MAP_DEFEATED_DURING_ASSAULT", A_S), 33, 0, 0);
        ...
        void MA_PRZYGODA(int A, int NR)
        {
            ...
            if (TYP == 3)
            {
                ...
                if (WYNIK_AKCJI == 1)
                {
                    M = 0;
                    CO = ARM;
                    A_S = TR("ADV_REWARD_GOLD", amos.Str_S(PRZYGODY[NR, P_NAGRODA]));
                    B = 41;
            ...
            if (TYP == 11)
            {
                ...
                if (ARMIA[WRG, 10, TE] <= 0)
                {
                    M = 0;
                    CO = ARM;
                    A_S = TR("ADV_BANDIT_HEAD_REWARD", amos.Str_S(PRZYGODY[NR, P_NAGRODA]));
                    B = 41;
                    GRACZE[1, 1] += PRZYGODY[NR, P_NAGRODA];
                }
            }
            ...
            if (TYP == 13)
            {
                ...
                if (WYNIK_AKCJI == 1)
                {
                    ...
                    OUTLINE(10, 200, TR("BOSS_INTRO_1"), 1, 0);
                    OUTLINE(10, 210, TR("BOSS_INTRO_2"), 1, 0);
                    OUTLINE(10, 220, TR("BOSS_INTRO_3"), 1, 0);
                    OUTLINE(10, 230, TR("BOSS_INTRO_4"), 1, 0);
                    OUTLINE(10, 240, TR("BOSS_INTRO_5"), 1, 0);
                    screens.View();
                    _WAIT(1500);
                    screens.Fade(2);
                    _TRACK_FADE(1);
                    //Erase 3
                    SETUP(TR("SETUP_BATTLE"), TR("SETUP_WITH_LORD"), TR("SETUP_OF_CHAOS"));
                    //'sparing z bossem
                    ...
                    if (WYNIK_AKCJI == 1)
                    {
                        ...
                        USTAW_FONT("defender2", 8);
                        OUTLINE(10, 200, TR("BOSS_DEFEAT_1"), 1, 0);
                        OUTLINE(10, 210, TR("BOSS_DEFEAT_2"), 1, 0);
                        OUTLINE(10, 220, TR("BOSS_DEFEAT_3"), 1, 0);
                        OUTLINE(10, 230, TR("BOSS_DEFEAT_4"), 1, 0);
                        OUTLINE(10, 240, "", 1, 0);
                        A_S = TR("ADV_COMPLETE");
                        M = 0;
                        CO = ARM;
        ...
        void MA_POLOWANIE(int A)
        {
            ...
            if (amos.Rnd(LOS) == 1)
            {
                ...
                var Y = ARMIA[A, 0, TY];
                CENTER(X, Y, 1);
                MESSAGE(A, TR("MAP_TRACKED_BEAST"), 0, 0);
                ARM = A;
                WRG = 40;
                screens.SpriteOff(2);
                SETUP("", "Polowanie", "");
