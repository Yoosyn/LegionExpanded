...
namespace AmigaNet.Legion
{
    public partial class Legion
    {
        ...
        public Legion(String langId, String resourcesPath, String dataPath, IGameEngine gameEngine)
        {
            LANG = langId;
            KAT_S = dataPath;
        ...
        void _INTRO()
        {
            ...
            screens.AmalRun(0, screens.Display.Sprites[0], new AmalBuilder()
                            .Anim(0,
            ...
            do
            {
                ...
                screens.Fade(2, FADE_BLACK_0_16());
                _WAIT(30);
                if (KONIEC_INTRA > 2) break;
                screens.Screen(0);
        ...
        /// <summary>
        /// AMOS "Fade n,0,0,...,0" (17 zeros): fades only the decorative
        /// palette range (indices 0-16) to black, leaving the bob/text ink
        /// colours (17-31, e.g. index 28 used for credits text) untouched.
        /// </summary>
        Pixel[] FADE_BLACK_0_16()
        {
            var colors = new Pixel[17];
            for (var i = 0; i <= 16; i++)
            {
                colors[i] = new Pixel(0, 0, 0, i);
            }
            return colors;
        }
        ...
        void _LOAD(String A, int TRYB)
        {
            ...
            if (TRYB == 7) ;//TODO: AMOS "Music" bank format (bank 3) - not yet implemented, see PORTING_PLAN.md item 3
            if (TRYB == 8) banks.Load(fileName, 4);
            if (TRYB == 9) banks.Load(fileName, 5);
